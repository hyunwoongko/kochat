...
DATA = {
    ...
    'intent_data_file': BACKEND['root_dir'] + "data/intent_data.csv",
    'entity_data_file': BACKEND['root_dir'] + "data/entity_data.csv",
}

MODEL = {
    'embed_dir': BACKEND['root_dir'] + "models/embed",
    'intent_dir': BACKEND['root_dir'] + "models/intent",
    'entity_dir': BACKEND['root_dir'] + "models/entity",

    'embed_processor_file': BACKEND['root_dir'] + "models/embed/fasttext",
    'intent_classifier_file': BACKEND['root_dir'] + "/models/intent/classifier.pth",
    'intent_retrieval_file': BACKEND['root_dir'] + "/models/intent/retrieval.pth",
    'entity_recognizer_file': BACKEND['root_dir'] + "/models/entity/recognizer.pth",
}
...
EMBEDDING = {
    ...
    'iter': 3000  # num of iteration for embedding training
}
...
ENTITY = {
    ...
    'epochs': 500,  # num of epoch for entity training
