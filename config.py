...
EMBEDDING = {
    ...
    'min_count': 2,  # removing min count word during embedding training
    'sg': 1,  # 0 : cbow / 1 : skip gram
    'iter': 1000  # num of iteration for embedding training
}
...
INTENT = {
    ...
    'epochs': 800,  # num of epoch for intent training
    'd_model': 256,  # model dimension for intent training
    'layers': 1,  # number of hidden layer for intent training
