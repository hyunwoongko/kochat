...
class LargeMarginSoftmaxLoss(nn.CrossEntropyLoss):
    """
    Intra Class인 데이터 샘플들 사이를 더욱 멀어지게 만드는
    Large Margin Softmax 로스 함수입니다.

    Code Refernce: https://github.com/tk1980/LargeMarginInSoftmax
    TODO : 앵귤러 마진 로스들 (sphereface, cosface, arcface 등 실험해보기)
    """

    def __init__(self, factor, ignore_index=-100):
        super(LargeMarginSoftmaxLoss, self).__init__(weight=None,
    ...
    def forward(self, x, labels):
        ...
        return loss + self.factor * margin_loss.mean()
