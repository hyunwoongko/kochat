...
from base.data_managers.data_manager import DataManager
...
class DataGenerator(DataManager):
    ...
    def _generate_intent(self):
        ...
        DataFrame(intent_files).to_csv(path_or_buf='../data/intent_data.csv',
                                       index=False,
    ...
    def _generate_entity(self):
        ...
        entity_files.to_csv(path_or_buf='../data/entity_data.csv',
                            index=False,
