...
class Visualizer:
    ...
    def draw_feature_space(self, feats, labels, label_dict, loss_name, d_loss, epoch, mode):
        """
    ...
    def __2d_feature_space(self, feats, labels, label_dict):
        """
    ...
    def __3d_feature_space(self, feats, labels, label_dict, d_loss):
        """
