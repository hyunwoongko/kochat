...
생각보다 큰 관심을 받으면서, 한국어로 된 챗봇 구현체가 정말 많이 없다는 것을 느꼈습니다. 
현재 대부분의 한국어 챗봇 빌더들은 대부분 일반인을 겨냥하기 때문에 웹상에서
손쉬운 UX/UI 기반으로 서비스 중입니다. 일반인 사용자는 정말 사용하기 편리하겠지만,
저와 같은 머신러닝 개발자들은 모델도 커스터마이징 하고 싶고, 로스함수도 추가하고싶고, 
